...
st.header("Программа для классфикации погодных условий ")
st.markdown('<style>' + open('./style.css').read() + '</style>', unsafe_allow_html=True)
ResNet_model = tf.keras.models.load_model(r'C:\НЕ УДАЛЯТЬ НИКОГДА НИ ПРИ КАКИХ УСЛОВИЯХ !!!!\first\first_ResNet50V2_model') 
